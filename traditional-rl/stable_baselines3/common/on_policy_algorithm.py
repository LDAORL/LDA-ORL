...
class OnPolicyAlgorithm(BaseAlgorithm):
    ...
    def learn(
        ...
        total_timesteps: int,
        upper_timesteps: Optional[int] = None,
        ...
        upper_timesteps = upper_timesteps if upper_timesteps is not None else total_timesteps

        while self.num_timesteps < upper_timesteps:
            t_start = time.time()
            continue_training = self.collect_rollouts(self.env, callback, self.rollout_buffer, n_rollout_steps=self.n_steps)
            self.logger.record("time/collection", time.time() - t_start)
            ...
            print('num_timesteps inside', self.num_timesteps)
            print('total_timesteps inside', total_timesteps)
            print('progress inside', self._current_progress_remaining)
