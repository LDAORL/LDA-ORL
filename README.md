...
**A Snapshot of Influence: A Local Data Attribution Framework for Online Reinforcement Learning** (NeurIPS 2025 <span style="color:red">Oral</span>), the first framework of data attribution for online reinforcement learning.
